...
<head>
  ...
  <?php
	   ...
	   */
	?>
	<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'stylesheet_directory' ); ?>/css/jquery-ui-1.8.6.custom.css" />
...
<body>
  <div id="header" class="block">
	...
	<?php 
	  $klass = "";
	  if (is_home() || is_category() || is_archive() || is_search() || is_single() || is_404() ) {
	    $klass = 'collection';
	  } elseif (is_page()) {
	    $klass = 'page';
	  }	  
